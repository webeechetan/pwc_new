...
<div class="content-body">
    ...
    <div class="container-fluid">
        ...
        <form class="bg-white p-4" name="case" enctype="multipart/form-data" method="post" action="{{ route('knowledge_sharing.store') }}">
        @csrf()
            <!-- Image Section -->
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12 mb-2">
                    <div class="form-group">
                        ...
                        <input type="file" name="ppts[]" class="form-control" required multiple />
                    </div>
                </div>
            </div>
            <div class="row">
