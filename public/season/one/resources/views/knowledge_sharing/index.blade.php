    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-8 mx-auto text-center text-white wow zoomIn">
               <h2 class="title text-white mb-3 mb-md-4">@php echo ($recent ? $recent->title : ( $KnowledgeSharing && count($KnowledgeSharing) == 0 ? 'Coming Soon' : 'Recent Case Study')) @endphp</h2>
               <a href="/knowledge_sharing/@php echo $recent ? $recent->id : '#' @endphp" class="btn btn-green">Read More</a>
            </div>
         </div>
    </div>
</section>
...
<section class="content-sec case-study-list sec-space">
    <div class="container">
        <div class="row">
            @if(!empty($KnowledgeSharing) && count($KnowledgeSharing) > 0)
                @foreach($KnowledgeSharing as $case)
                <div class="col-md-4">
                    <div class="case-item">
                        <a href="{{env('APP_URL')}}/knowledge_sharing/{{$case->id}}">
                            <div class="case-img">
                                <img src="{{ asset('uploads/knowledge_sharing') }}/{{ $case->banner_image }}">
