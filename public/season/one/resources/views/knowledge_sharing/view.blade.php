...
@section('title') Knowledge Sharing @endsection

@section('body')
<!-- Hero Section -->
<section class="hero-banner sec-space" style="background-image: url({{ asset('uploads/knowledge_sharing/'.$KnowledgeSharing->banner_image) }});background-size:cover;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-xl-8 mx-auto text-center text-white wow zoomIn">
               <h2 class="title text-white">{{$KnowledgeSharing->title}}</h2>
            </div>
         </div>
    </div>
</section>
...
<section class="bg-primary py-2">
    <div class="container">
        ...
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/knowledge_sharing">Knowledge Sharings</a></li>
...
<section class="sec-space bg-light">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="title mb-3 mb-md-4">{{$KnowledgeSharing->title}}</h3>
                <!-- <p>{!! $KnowledgeSharing->overview !!}</p> -->
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            @foreach($files as $file)
                <div>
                    <a href="{{ asset('uploads/knowledge_sharing') }}/{{$file}}">{{ $file }}</a>        
                </div>
            @endforeach
        </div>
        <div class="row">
